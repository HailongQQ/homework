...
CREATE LOGIN luohailong
WITH PASSWORD='luohailong',
...
CREATE USER [usr1] FOR LOGIN [luohailong]
CREATE USER [usr2] FOR LOGIN [luohailong]
CREATE USER [usr3] FOR LOGIN [luohailong]
GO 
